...
func (s *UIServerAPI) Export(ctx context.Context, addr common.Address) (stdjson.RawMessage, error) {
...
func (api *UIServerAPI) Import(ctx context.Context, keyJSON stdjson.RawMessage, oldPassphrase, newPassphrase string) (accounts.Account, error) {
